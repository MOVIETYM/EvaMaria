...
#THE OWNER OF THIS CODE IS https://github.com/Ns-AnoNymouS/Stylish-Text
#Also part of https://github.com/PR0FESS0R-99/LuciferMoringstar-Robot
...
async def style_buttons(c, m, cb=False):
    ...
    if ' ' in m.text:
        ...
        await m.reply_text(text="Enter Any Text Eg `/text [text]`")
